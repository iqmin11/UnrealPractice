...
// End Cross Module References
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AMovingPlatform_Statics::NewProp_Myboolean_MetaData[] = {
		{ "Category", "MovingPlatform" },
		{ "ModuleRelativePath", "MovingPlatform.h" },
	};
#endif
	void Z_Construct_UClass_AMovingPlatform_Statics::NewProp_Myboolean_SetBit(void* Obj)
	{
		((AMovingPlatform*)Obj)->Myboolean = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AMovingPlatform_Statics::NewProp_Myboolean = { "Myboolean", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(AMovingPlatform), &Z_Construct_UClass_AMovingPlatform_Statics::NewProp_Myboolean_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AMovingPlatform_Statics::NewProp_Myboolean_MetaData), Z_Construct_UClass_AMovingPlatform_Statics::NewProp_Myboolean_MetaData) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AMovingPlatform_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AMovingPlatform_Statics::NewProp_Myboolean,
	};
	...
	struct Z_CompiledInDeferFile_FID_Users_iqmin_OneDrive_Desktop_HSM_Coding_UnrealPractice_Unreal_Project_ObstacleAssault_Source_ObstacleAssault_MovingPlatform_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_iqmin_OneDrive_Desktop_HSM_Coding_UnrealPractice_Unreal_Project_ObstacleAssault_Source_ObstacleAssault_MovingPlatform_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AMovingPlatform, AMovingPlatform::StaticClass, TEXT("AMovingPlatform"), &Z_Registration_Info_UClass_AMovingPlatform, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AMovingPlatform), 3261222466U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_iqmin_OneDrive_Desktop_HSM_Coding_UnrealPractice_Unreal_Project_ObstacleAssault_Source_ObstacleAssault_MovingPlatform_h_2900790312(TEXT("/Script/ObstacleAssault"),
		Z_CompiledInDeferFile_FID_Users_iqmin_OneDrive_Desktop_HSM_Coding_UnrealPractice_Unreal_Project_ObstacleAssault_Source_ObstacleAssault_MovingPlatform_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_iqmin_OneDrive_Desktop_HSM_Coding_UnrealPractice_Unreal_Project_ObstacleAssault_Source_ObstacleAssault_MovingPlatform_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
